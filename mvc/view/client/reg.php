                        ...
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__social">
                                ...
                                <?php if(!isset($_SESSION['name'])) {
                                    ...
                                    echo 'Xin chào: ' . $_SESSION['name']. '   <a href="login/logout">Đăng xuất</a>';                            } ?>
...
<div class="container">
    ...
    <!-- end form chọn đăng nhâp  -->
    <!-- điền thông tin đăng kí  -->
    <form class="dnmb"  action="reg/reg" enctype="multipart/form-data" method="POST">
        <div  class="form-group">
          <input type="text" placeholder="Tên đăng nhập" class="form-control form-control-lg" id="ho" name="ten_dang_nhap">
        </div>
        <div class="form-group">
          <input type="password" placeholder="Mật khẩu" class="form-control form-control-lg" id="ten" name="mat_khau">
        </div>
        <div class="form-group">
          <input type="password" placeholder="Nhập lại mật khẩu" class="form-control form-control-lg" id="ten" name="re_mat_khau">
        </div>
        <div class="form-group">
            <input type="number"placeholder="Số điện thoại" class="form-control form-control-lg" id="dt" name="so_dien_thoai">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <input type="date"placeholder="Ngày sinh" class="form-control form-control-lg" id="email" name="ngay_sinh">
          </div>

          <div class="form-group">
            <input type="text"placeholder="Địa chỉ" class="form-control form-control-lg" id="email" name="dia_chi">
          </div>
      <!-- end điền thông tin -->
                    <?= $data['thong_bao'] ?>
      <!-- button dang kí  -->
      <div class="row">
      <button  type="submit" class="btn btn-dark" name="dangky">Tạo tài khoản</button>
      ...
      <!-- đăng nhâp  -->
      <div class="row">
        <a class="qmk" href="login/">Đăng Nhập</a>  
      </div>
      <!-- end dăng nhap -->
</div>
   <!-- end form dang nhap  -->
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <a href="./index.html"><img style="width: 100%;height: 50px;" src="public/client/img/Was.png" alt="#"></a>
                        </div>
                        <ul>
